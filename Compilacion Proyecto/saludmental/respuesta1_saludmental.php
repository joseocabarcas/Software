        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 centered">
                    <h1>Finalizaste!</h1>
                    <p>Se le informa que los resultados arrojan una alteración muy grave en su estado de salud mental, ya sea, por alteraciones en su porte y aptitud, alteraciones de afecto, alteraciones de sueño, etc.</p>
                    <p>Se le recomienda que asista con un psiquiatra o con un psicologo de cabecera para que este lo termine de dictaminar y lo ayude a superar sus problema relacionados con su bienestar mental.</p>
