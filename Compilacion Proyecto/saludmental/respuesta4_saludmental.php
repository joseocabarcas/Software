        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 centered">
                    <h1>Finalizaste!</h1>
                    <p>Se le diagnostica que Usted manifiesta un adecuado comportamiento en todas las fases de su estado de salud mental</p>
                    <p>Se le hes recomendable seguir realizandose consultas en determinados tiempos (si piensa que esta teniendo problemas) y si es el caso asistir con un profesional.</p>
