        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 centered">
                    <h1>Finalizaste!</h1>
                    <p>Se le informa que los resultados arrojan una alteracion que genera alerta acerca de problemas en su estado de salud mental, ya sea, por alteraciones en su porte y aptitud, alteraciones de afecto, alteraciones de sueño, etc. Se logro identificar que existe la tendencia hacias estas alteraciones.</p>
                    <p>Se le hes recomendable asistir con un psicologo y que este le determine las razones las cuales les esta generando estas alteraciones en su estado de salud mental.</p>
