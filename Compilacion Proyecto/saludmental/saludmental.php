            ...
            <div class="container pt">
                <div class="row mt">
                    <div class="col-lg-4 col-lg-offset-4 centered">
                        <img src="../img/imagen_mental.png" class="img-responsive">
                        <h3>Salud Mental</h3>
                        <hr>
                        <p>Instrumento psicologico que permite la detección temprana del estado de salud mental de las personas</p>
                    </div>
                </div>
