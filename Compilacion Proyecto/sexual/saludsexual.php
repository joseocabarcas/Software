            ...
            <div class="container pt">
                <div class="row mt">
                    <div class="col-lg-4 col-lg-offset-4 centered">
                        <img src="../img/imagen_sexo.png" class="img-responsive">
                        <h3>Salud Sexual Masculinna</h3>
                        <hr>
                        <p>Test acerca de la disfunción eréctil o impotencia que se refiere a la incapacidad para alcanzar y mantener una erección suficiente para tener una relación sexual. Esta patología puede desencadenar importante estrés, problemas de pareja y alteración de la autoestima. La disfunción eréctil es muy frecuente, afectando en grado variable a casi la mitad de los hombres entre los 40 y 70 años de edad.</p>
                    </div>
                </div>
