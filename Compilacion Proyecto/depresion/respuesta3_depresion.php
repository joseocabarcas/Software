        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 centered">
                    <h1>Finalizaste!</h1>
                    <p>Se le a detectado un nivel severo de Depresión Geriátrica. Se le recomienda acudir con un especialista para que este lo guie y le brinde el tratamiento requerido.</p>
