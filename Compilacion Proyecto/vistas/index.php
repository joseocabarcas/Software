              ...
              <div class="container">
                ...
                <div class="navbar-collapse collapse">
                  <ul class="nav navbar-nav navbar-right">
                    <li><a class="one" href="registro.php">Registrarse</a></li>
                    <li><a class="two" href="login.php">Iniciar Sesion</a></li>
                    <li><a class="tree" href="about.php">Acerca de</a></li>
                  </ul>
                </div><!--/.nav-collapse -->
              </div>
            </div>
...
var tour = new Tour({
  steps: [
  {
    element: ".one",
    title: "Registrarse",
    content: "Registrarse en el sistema"
  },
  {
    element: ".two",
    title: "Logueo",
    content: "Autenticarse en el sistema"
  },
  {
    element: ".tree",
    title: "Nosotros",
    content: "Informacion acerca de nosotros "
  },
  {
    element: ".carousel-inner",
    title: "Informacion",
    content: "Informacion acerca de los test evaluados "
  },
                ...
                <div class="item active ">
                  ...
                  <div class="container">
                    <div class="carousel-caption">
                      ...
                      <p><a class="btn btn-lg btn-primary" href="../saludmental/saludmental.php" role="button">Ver mas..</a></p>
                    </div>
                  </div>
                </div>
                <div class="item">
                  ...
                  <div class="container">
                    <div class="carousel-caption">
                      ...
                      <p><a class="btn btn-lg btn-primary" href="../sexual/saludsexual.php" role="button">Ver mas..</a></p>
                    </div>
                  </div>
                </div>
                <div class="item">
                  ...
                  <div class="container">
                    <div class="carousel-caption">
                      ...
                      <p><a class="btn btn-lg btn-primary" href="../depresion/depresion.php" role="button">Ver mas..</a></p>
                    </div>
                  </div>
                </div>
                <div class="item">
                  ...
                  <div class="container">
                    <div class="carousel-caption">
                      ...
                      <p><a class="btn btn-lg btn-primary" href="../psicopatologia/psicopatologia.php" role="button">Ver mas..</a></p>
                    </div>
                  </div>
                </div>
                <div class="item">
                  ...
                  <div class="container">
                    <div class="carousel-caption">
                      ...
                      <p><a class="btn btn-lg btn-primary" href="../enamoramiento/enamoramiento.php" role="button">Ver mas..</a></p>
                    </div>
                  </div>
                </div>
                <div class="item ">
                  ...
                  <div class="container">
                    <div class="carousel-caption">
                      ...
                      <p><a class="btn btn-lg btn-primary" href="../ninos/sintomasninos.php" role="button">Ver mas..</a></p>
                    </div>
                  </div>
                </div>
              </div>
