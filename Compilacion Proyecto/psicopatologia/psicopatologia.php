            ...
            <div class="container pt">
                <div class="row mt">
                    <div class="col-lg-4 col-lg-offset-4 centered">
                        <img src="../img/imagen_psicopatologia.png" class="img-round">
                        <h3>Psicopatologia</h3>
                        <hr>
                        <p>Test desarrollado por la Organizacion Mundial de la Salud (OMS) para detectar la presencia de trastornos no psicoticos (menores o comunes) en atencion primaria en paises en desarrollo.</p>
                    </div>
                </div>
