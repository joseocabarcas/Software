        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 centered">
                    <h1>Finalizaste!</h1>
                    <p>Se le indica que se le debe realizar al niño una evaluacion integral por el medico de nivel primario y persisten dudas debe acercarse a un especialista en psiquiatria o psicologia para evaluacion integral, diagnostico, tratamiento y seguimiento</p>
