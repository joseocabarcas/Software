            ...
            <div class="container pt">
                <div class="row mt">
                    <div class="col-lg-4 col-lg-offset-4 centered">
                        <img src="../img/imagen_ninos.png" class="img-round">
                        <h1>Niños</h1>
                        <hr>
                        <h2>CUESTIOARIO DE SINTOMAS PARA NIÑOS RQC</h2>
                        <hr>
                        <p>(El cuestionario de reporte para niño), elaborado en colaboracion de la Organizacion Mundial de la Salud para la atencion a los problemas de salud mental en los paises en desarrollo</p>
                </div>
                    </div>
                </div>
